            ...
            <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl p-6 md:p-10 border-t-8 border-indigo-600">
                ...
                <div className="mb-10 text-center">
                    <h2 className="text-4xl font-extrabold text-indigo-800 tracking-tight">
                        <span className="inline-block transform -rotate-6 text-yellow-500 mr-2"></span> Create New Exam
                    </h2>
                    <p className="text-gray-500 mt-2 text-md">
                        Design your exam structure, define general settings, and add questions.
                    </p>
                </div>
                                ...
                                >
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                else toast.info("At least one question is required to save the exam.");
                                            }}
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4 mb-6">
                                        {OptionLabels.map((label, optIdx) => (
                                            <div key={optIdx} className="flex items-center space-x-2 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                                <span className="font-bold text-indigo-600 w-6 h-6 flex items-center justify-center bg-indigo-100 rounded-full text-xs shrink-0">{label}</span>
                                                <input
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            {questions[index] && questions[index].Options.map((optionText, optIdx) => (
