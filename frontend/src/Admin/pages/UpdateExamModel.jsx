      ...
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-6 relative overflow-y-auto max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
          ...
          <div className="p-6 bg-indigo-50 rounded-xl border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input {...register("ExamName")} placeholder="Exam Name" className="border p-3 rounded" />
              <input {...register("ExamCode")} placeholder="Exam Code" className="border p-3 rounded" />
              <input {...register("Class")} placeholder="Class" className="border p-3 rounded" />
              <input
                {...register("Duration")}
                type="number"
                min={1}
              ...
              />
              <input {...register("MarkPerQuestion", { valueAsNumber: true })} type="number" placeholder="Marks / Question" className="border p-3 rounded" />
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 flex gap-2 items-center">
              <NotebookText /> Questions ({fields.length})
            </h3>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="bg-green-600 text-white p-3 rounded font-semibold disabled:bg-green-400"
          >
