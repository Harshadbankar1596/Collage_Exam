...
import { useGetAllExamQuery, useDeleteExamMutation } from "../../redux/Admin/AdminApi";
        ...
        <div className="w-full">
            ...
            <div className="mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-lg">Manage and monitor your examinations</p>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-blue-500">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-800">{exams?.exams?.length || 0}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-4 text-white">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <h3 className="text-xl font-bold mt-2 line-clamp-1">{exam.ExamName}</h3>
                                    </div>
