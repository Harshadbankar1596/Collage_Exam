        ...
        <div className="min-h-screen w-full p-6">
            ...
            <nav className="bg-white shadow-md rounded-xl p-5 flex justify-between items-center mb-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to={"/admin/login"} className="bg-red-500 hover:bg-red-600 p-2 rounded-lg text-white flex items-center gap-2">
                        <LogOut size={18} />
                        Logout
                    </Link>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <h2 className="text-2xl font-bold">{data?.admin?.ConductedExams?.length}</h2>
                    </div>
                </Link>
